...
@WebServlet("/EditProfileMailVerifier")
public class EditProfileMailVerifier extends HttpServlet 
{
	...
	private void sendEmail(String to, String from, String subject, String otp) 
	{
	  ...
	  { 
		...
		msg.setText("YOUR OTP FROM SvvvInvento FOR EDITING THE PROFILE: "+otp);
