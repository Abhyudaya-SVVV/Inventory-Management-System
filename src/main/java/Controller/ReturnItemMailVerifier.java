...
@WebServlet("/ReturnItemMailVerifier")
public class ReturnItemMailVerifier extends HttpServlet 
{
	...
	private void sendEmail(String to, String from, String subject, String otp) 
	{
	  ...
	  { 
		...
		msg.setText("YOUR OTP FROM SvvvInvento FOR RETURNING THE ITEM: "+otp);
